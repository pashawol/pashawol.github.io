...
{
	return BX.ajax.loadJSON('http://blagodaryu.pro/bitrix/tools/ajax_captcha.php', callback);
};
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		BX.ready(function ()
		{
			...
			if (test == 'view/' || test == 'view%')
			{
				...
				var url = 'http://blagodaryu.pro/bitrix/tools/ajax_redirector.php?hash=' + current_hash;
