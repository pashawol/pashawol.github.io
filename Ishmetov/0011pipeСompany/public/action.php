...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['prod'])) {
        $html .= ' <tr style="background-color: #f8f8f8;">  <td style="padding: 10px; bprod: #e9e9e9 1px solid;">Вид формы:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['order'] . '</b></td></tr>';
    }
