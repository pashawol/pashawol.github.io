 ...
 */
$ui->pageName = 'Редактировать страницу партнёров';
$ui->createBreadcrumbs($model->page, 'Редактировать страницу');
$ui->menu = array(
    array('label'=>'Список партнёров', 'url'=>$model->page->getRoute()),
    array('label'=>'Добавить партнёра', 'url'=>array('partner/create'), 'icon'=>'plus'),
);
