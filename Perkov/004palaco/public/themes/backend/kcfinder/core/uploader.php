...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    protected function rus2translit($s)
    {
		$converter = array(
    ...
    protected function normalizeFilename($filename) {
        return preg_replace('/[^A-Za-z0-9\-\._]/', '_', $this->rus2translit($filename));
        /*
    ...
    protected function normalizeDirname($dirname) {
        return preg_replace('/[^A-Za-z0-9\-\._]/', '_', $this->rus2translit($dirname));
        /*
