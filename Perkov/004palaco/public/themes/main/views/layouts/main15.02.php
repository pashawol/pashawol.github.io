...
<!--                            <h1>Мебель для домов и квартир под ключ</h1>-->
...
?>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 footer__section contacts">
            ...
            <div class="contacts__icons">
              <span>Напишите нам: </span>
<!--             </span>
              <a target="_blank" href="//vk.com/palazo"><img src="/uploads/social/vk.png" alt="VK"></a>
              <a target="_blank" href="https://www.facebook.com/palazo.ru"><img src="/uploads/social/fb.png" alt="Facebook"></a>
              <a target="_blank" href="viber://chat?number=79103706670"><img src="/uploads/social/viber.png" alt="Viber"></a>
              <a target="_blank" href="https://api.whatsapp.com/send?phone=79103706670"><img src="/uploads/social/wa.png" alt="What's App"></a>
            </div> -->
          ...
          <div class="col-lg-2 col-md-6 col-sm-12 footer__section payment">
            <div class="payment__share">
             ...
             <!--  <script src="https://www.facebook.com/connect.php/js/FB.Share"></script> -->



<!--               <a href="#" class="payment__icon">
                <img src="/uploads/social/ok-sq.png" alt="Одноклассники">
              </a>     -->   
            </div>
<!--            <button data-toggle="modal" data-target="#myModal-x" class="payment__btn-black">Онлайн-расчёт</button>-->
            <button data-toggle="modal" data-target="#myModal-x" class="payment__btn-red">Онлайн-расчёт</button>
<!--            <button class="payment__btn-red">Заказать консультацию</button>-->
          </div> 
        </div>
      </div>               
      <div class="copy">
