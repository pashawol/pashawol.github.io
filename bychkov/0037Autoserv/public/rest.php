...
define('CRM_HOST', 'dasweltauto.bitrix24.ru'); // your CRM domain name
define('CRM_PORT', '443'); // CRM server port
define('CRM_PATH', '/crm/configs/import/lead.php'); // CRM server REST service path

// CRM server authorization data
define('CRM_LOGIN', 'Dmitry.amme@gmail.com'); // login of a CRM user able to manage leads
define('CRM_PASSWORD', 'Diverstrade'); // password of a CRM user
