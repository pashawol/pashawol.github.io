...
$(function() {
  ...
  initSlideshow('.slideshow','.slideshow-slide');
...
function popupClose(){
  ...
  $('.js-open-order').on('click',function(){
            $('#order_form').popup('#fff',0.3,1000,400);
            return false;
        });
 ...
 $('.popup-close').on('click',function() {
  ...
  return false
   ...
   $(document).on('click', '.btn_call_order', function () {
            var btn = $(this);
            btn.hide();
            var h1_content = $('h1').html();
            var name = $('.call_order_form_name').val();
            var phone = $('.call_order_form_phone').val();
            var user_mail=$('.call_order_form_maill').val();
            var item = $('.call_order_form_sel').val();
            if (name == "") {
                btn.show();
                $.growl({'title':'Внимание', message:'Заполните все поля формы!'});
                return false;
            }
            if (phone == "") {
                btn.show();
	   ...
	   $.post('/php_script/send_form_order_call.php', {'h1': h1_content, 'name': name, 'phone': phone, 'maill': user_mail, 'item':item}, function (data) {
                if (data.success == "yep") {
                    $.growl({'title':'Внимание', message:'Спасибо, за Вашу заявку. Мы свяжемся с Вами в ближайшее время.'});
                    $('.call_order_form_name').val('');
                    $('.call_order_form_phone').val('');
                    $('.call_order_form_maill').val('');
                    $(".call_order_form_sel option:first").attr('selected','selected');
 ...
 /* $('.js-open-nav').on('click',function () {
    ...
    _this.parent().find('>.sidenav-body').stop().slideToggle();
    _this.parent().find('.sidenav-body-filter-wrap').toggleClass('active');
  });*/
  ...
  initJcarousel('.discount-carusel');

  initJcarouselRecommend('.recommend-carusel-body');

  addFixedBar('.js-fixed-bar');
  $(window).on('scroll resize',function(){
    addFixedBar('.js-fixed-bar');
  });

  tabs('.pro-pic-min-list','.pro-pic-min-item','.pro-left','.pro-pic',200);

  initJcarouselPro('.pro-pic-min-body');

  $('.js-toggle-class').on('click', 'span', function () {
    var _this = $(this);
    _this.toggleClass('active');
    _this.siblings().removeClass('active');
  });

  $('.sort-menu').on('click', '.sort-menu-head', function () {
    var _this = $(this);
    var _thisParent = _this.parent();
    _thisParent.find('.sort-menu-body').toggle();
    $(document).on('click',function(event){
      if ($(event.target).parents('.sort-menu').length != 1) {
        _thisParent.find('.sort-menu-body').hide();
      }
    });
  });

  $('.filter-btn').on('click', '.filter-btn-link', function () {
    var _this = $(this);
    _this.toggleClass('active');
  });

  initJcarouselPro('.reviews-carusel-body');

  $('.faq-body').on('click','.faq-item-link',function () {
    var _this = $(this);
    var _thisParent = _this.closest('.faq-item');
    var _thisParentSibl = _thisParent.siblings('.faq-item');
    _this.toggleClass('active');
    _thisParent.find('.faq-item-content').stop().slideToggle();
    _thisParentSibl.find('.faq-item-link.active').removeClass('active');
    _thisParentSibl.find('.faq-item-content').slideUp();
  });
  ...
  $('.scroll-animate').each(function () {
    ...
    $(window).scroll(function() {
      var half = block.height() / 2;
      var top = block.offset().top ;
      var bottom = block.height() + top;
      top = top - $(window).height();
      var scroll_top = $(this).scrollTop();
      if ((scroll_top > (top+half)) && (scroll_top < (bottom-half)) ) {
  ...
  /**/
  $('.delivery-item:eq(2) .delivery-pic').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1, {css:{opacity:0,transform:"scale(0, 0)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"scale(1.0, 1.0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    $(this).css('opacity', 0);
    $(this).css('transform','scale(0.3, 0.3)');
  });
  $('.delivery-item:eq(1) .delivery-pic,.delivery-item:eq(3) .delivery-pic').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.5, {css:{opacity:0,transform:"scale(0, 0)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"scale(1.0, 1.0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    $(this).css('opacity', 0);
    $(this).css('transform','scale(0.3, 0.3)');
  });
  $('.delivery-item:eq(0) .delivery-pic').on('animateIn', function() {
    TweenMax.fromTo( $(this), 2, {css:{opacity:0,transform:"scale(0, 0)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"scale(1.0, 1.0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    $(this).css('opacity', 0);
    $(this).css('transform','scale(0.3, 0.3)');
  });
  ...
  $('.bene-item:eq(0)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 2, {css:{opacity:0,transform:"translate(-550px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translate(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translate(-550px)"}, ease:"easeOutSine" });
  });
  $('.bene-item:eq(1)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.5, {css:{opacity:0,transform:"translate(-550px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translate(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translate(-550px)"}, ease:"easeOutSine" });
  });
  $('.bene-item:eq(2)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1, {css:{opacity:0,transform:"translate(-550px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translate(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translate(-550px)"}, ease:"easeOutSine" });
  });
  ...
  $('.style-ol li.animate:eq(0)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .1, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(1)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .2, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(2)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .4, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(3)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .6, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(4)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .8, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(5)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(6)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.2, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });
  $('.style-ol li.animate:eq(7)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.4, {css:{opacity:0,transform:"translateY(50px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateY(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateY(50px)"}, ease:"easeOutSine" });
  });

  $('.style-ol1 li.animate:eq(0)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .3, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });

  $('.style-ol1 li.animate:eq(1)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .8, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });

  $('.style-ol1 li.animate:eq(2)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.2, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });
  $('.style-ol1 li.animate:eq(3)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 2.0, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });

  $('.style-ol2 li.animate:eq(0)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .3, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });

  $('.style-ol2 li.animate:eq(1)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .8, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });

  $('.style-ol2 li.animate:eq(2)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.2, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });
  $('.style-ol2 li.animate:eq(3)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 2.0, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });

  $('.reviews-carusel-list a.animate:eq(0)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .3, {css:{opacity:0,transform:"translateX(-150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(-150px)"}, ease:"easeOutSine" });
  });

  $('.reviews-carusel-list a.animate:eq(1)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .3, {css:{opacity:0,transform:"translateX(150px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(150px)"}, ease:"easeOutSine" });
  });
  ...
  $('.steps-body .steps-item:eq(0)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .5, {css:{opacity:0,transform:"translateX(350px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(350px)"}, ease:"easeOutSine" });
  });

  $('.steps-body .steps-item:eq(1)').on('animateIn', function() {
    TweenMax.fromTo( $(this), .8, {css:{opacity:0,transform:"translateX(350px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(350px)"}, ease:"easeOutSine" });
  }); 

  $('.steps-body .steps-item:eq(2)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.2, {css:{opacity:0,transform:"translateX(350px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(350px)"}, ease:"easeOutSine" });
  });

  $('.steps-body .steps-item:eq(3)').on('animateIn', function() {
    TweenMax.fromTo( $(this), 1.6, {css:{opacity:0,transform:"translateX(350px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(350px)"}, ease:"easeOutSine" });
  });

  $('.arr_bef').on('animateIn', function() {
    TweenMax.fromTo( $(this), 0.6, {css:{opacity:0,transform:"translateX(-350px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(-350px)"}, ease:"easeOutSine" });
  });


  $('.arr_aft').on('animateIn', function() {
    TweenMax.fromTo( $(this), 0.6, {css:{opacity:0,transform:"translateX(350px)"}, ease:Quad.easeInOut},{css:{opacity:1,transform:"translateX(0)"}, ease:Quad.easeInOut});
  }).on('animateOut', function() {
    TweenMax.to( $(this), 1, {css:{opacity:0,transform:"translateX(350px)"}, ease:"easeOutSine" });
  });
...
// function addFixedBar
function addFixedBar(a){
  var _this = $(a);
  ...
  if(paramWindows > paramFixedBar){
    _this.addClass('top-line--mod')
  }else{
    _this.removeClass('top-line--mod')
  }
}

// function initJcarousel
function initJcarouselPro(a) {
  var _this = $(a);
  if (_this.length > 0) {
    _this.parent().append('<a href="#" class="pro-pic-min-left jcarousel-control-prev ico-0000-arr-l"></a><a href="#" class="pro-pic-min-right jcarousel-control-next ico-0001-arr-r"></a>');
    _this.jcarousel({
      animation:   400
    });
...
// function initJcarousel
function initJcarouselRecommend(a) {
  var _this = $(a);
  if (_this.length > 0) {
    _this.parent().append('<a href="#" class="recommend-carusel-left jcarousel-control-prev ico-0013-arr-l"></a><a href="#" class="recommend-carusel-right jcarousel-control-next ico-0012-arr-r"></a>');
    _this.jcarousel({
      animation:   400
    });
    $('.jcarousel-control-prev')
...
function initJcarousel(a) {
  var _this = $(a);
  if (_this.length > 0) {
    _this.parent().find('.title').append('<div class="carusel-controls"><a href="#" class="carusel-left jcarousel-control-prev ico-0000-arr-l"></a><a href="#" class="carusel-right jcarousel-control-next ico-0001-arr-r"></a></div>');
    _this.jcarousel({
      animation:   400
    });
    $('.jcarousel-control-prev')
...
function initSlideshow(a,b){
  $(a).each(function(i, e){
    if($(b,e).length > 1){
      var _this = $(e);
      _this.append("<a href='#' class='slideshow-prev  ico-0013-arr-l cycle-prev'></a>" +
        "<a href='#' class='slideshow-next ico-0012-arr-r cycle-next'></a>");
      _this.cycle({
        fx:    'scrollHorz',
        timeout:  0,
        speed:  400,
...
(function($,undefined){
    ...
    $.fn.extend({
        ...
        fhtimer: function(options) {
            ...
            ////////////////////////////////
            var date = new Date();
            //date.setDate(date.getDate() + 2);  // кол-во дней до окончания - текущее время

            var defaults = {
                targetDD: parseInt(date.getDate()),//05,
                targetMM: parseInt(date.getMonth()),//12,
                targetYY: parseInt(date.getFullYear())//2013
            };
            ...
            return this.each(function() {
                ...
                setInterval(function() {
                    var dif = dateDiff(new Date(),((opt.targetMM + 1)+"/"+opt.targetDD+"/"+opt.targetYY));
    ...
    function dateDiff( str1, str2 ) {
        ...
        return isNaN( diff ) ? NaN : {
            ...
            s  : (Math.floor( diff /     1000 %   60 ) < 10) ? '0' + String(Math.floor( diff /     1000 %   60 )) : String(Math.floor( diff /     1000 %   60 )),
            m  : (Math.floor( diff /    60000 %   60 ) < 10) ? '0' + String(Math.floor( diff /    60000 %   60 )) : String(Math.floor( diff /    60000 %   60 )),
            h  : (Math.floor( diff /  3600000 %   24 ) < 10) ? '0' + String(Math.floor( diff /  3600000 %   24 )) : String(Math.floor( diff /  3600000 %   24 )),
            d  : (Math.floor( diff / 86400000        ) < 10) ? '0' + String(Math.floor( diff / 86400000        )) : String(Math.floor( diff / 86400000        ))
        };
    }
